...
4. Access via: `https://yourusername.github.io/Timetable-Planner/ index.html`

### File Changes Required

- Update manifest.json start_url to `/ index.html`
- Update service-worker.js to cache index.html, admin.html, view.html, shared.js, styles.css
...
| File       | Lines     | Purpose                  |
| ---------- | --------- | ------------------------ |
| index.html | ~300      | Authentication only      |
